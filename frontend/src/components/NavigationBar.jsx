...
import { FaSignInAlt, FaUserPlus, FaSignOutAlt, FaChartPie, FaFileInvoiceDollar } from 'react-icons/fa';
                    ...
                    <Nav className="me-auto">
                        ...
                        {isAuthenticated && (
                            <>
                                ...
                                <Nav.Link as={RouterNavLink} to="/reports">
                                    <FaFileInvoiceDollar className="me-1" /> Reports
                                </Nav.Link>
                            </>
                        )}
                    </Nav>
