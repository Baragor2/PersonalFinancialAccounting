...
function TransactionItem({ transaction, onEdit, onDelete, categoryMap }) {
    ...
    return (
        ...
        <Row className="align-items-center w-100">
            ...
            <Col md={1} xs={12} className="d-md-none mb-2">
                {transaction.description && (
            ...
            <Col md={2} xs={6} className={`text-center transaction-value ${valueColorClass}`}>
                {value.toLocaleString(undefined, { style: 'currency', currency: 'USD', minimumFractionDigits: 2, maximumFractionDigits: 2 })} {/* Замените USD на вашу валюту или уберите currency */}
            </Col>
